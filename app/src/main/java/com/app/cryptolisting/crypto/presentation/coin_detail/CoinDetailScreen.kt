...
import com.app.cryptolisting.crypto.presentation.coin_detail.components.InfoCard
import com.app.cryptolisting.crypto.presentation.coin_list.CoinListState
import com.app.cryptolisting.crypto.presentation.coin_list.components.previewCoin
import com.app.cryptolisting.crypto.presentation.coin_list.models.toDisplayableNumber
    ...
    if (state.isLoading){
        ...
        Column(
            modifier = Modifier.fillMaxSize().verticalScroll(rememberScrollState())
                .padding(16.dp,).padding(WindowInsets.safeDrawing.asPaddingValues()),
